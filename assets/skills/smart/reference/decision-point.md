...
Canonical path: `smart/reference/decision-point.md`

This protocol is shared by all smart sub-skills that contain user decision points. Any step labeled as a blocking point or user decision point must follow this protocol.
