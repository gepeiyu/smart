...
const TRANSLATIONS: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    setupComplete: 'Smart setup complete!',
    installed: 'Installed:',
    ...
    noInstallsFound: 'No platforms with smart skills installed. Run `smart init` first.',
    updatingSkillsOnTargets: 'Updating smart skills on',
  ...
  zh: {
    settingUp: '正在设置 Smart：',
    installScope: '安装范围：',
    scopeProject: '项目（当前目录）',
    scopeGlobal: '全局（主目录）',
    languagePrompt: 'Smart 技能语言：',
    ...
    noInstallsFound: '未检测到已安装 smart skills 的平台。请先运行 `smart init`。',
    updatingSkillsOnTargets: '正在更新 smart skills，覆盖',
